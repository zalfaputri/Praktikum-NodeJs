...
/* Endpoint a*/
// endpoint "/tampil" dengan method GET
...
app.get("/profil/:name/:Class", (req,res) => {
    let name = req.params.name
    let age = req.params.Class
    let response = {
        nama: name,
        umur: age
    }
...
app.post("/luas", (req,res) => {
    ...
    var panjang = Number(req.body.panjang) // mengambil nilai panjang dari body
    var lebar = Number(req.body.lebar) // mengamil nilai lebar dari body
